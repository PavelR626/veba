...
# Run
params=" -i ../../Analysis/veba_output/binning/${org_type}/ -c ../../Analysis/veba_output/cluster/output/global/mags_to_slcs.tsv -o ../../Analysis/veba_output/classify/${org_type}/ --n_jobs ${n_threads} --veba_database ${veba_database}"
